...
// For DSA only the matrix-related subset is included here.
...
public:
    ...
    PFNGLMATRIXMULTFEXTPROC matrixMultf = nullptr;
    PFNGLMATRIXLOADIDENTITYEXTPROC matrixLoadIdentity = nullptr;
    PFNGLMATRIXROTATEFEXTPROC matrixRotatef = nullptr;
    PFNGLMATRIXSCALEFEXTPROC matrixScalef = nullptr;
    PFNGLMATRIXTRANSLATEFEXTPROC matrixTranslatef = nullptr;
    PFNGLMATRIXFRUSTUMEXTPROC matrixFrustum = nullptr;
    PFNGLMATRIXORTHOEXTPROC matrixOrtho = nullptr;
    PFNGLMATRIXPOPEXTPROC matrixPop = nullptr;
    PFNGLMATRIXPUSHEXTPROC matrixPush = nullptr;

private:
    QNvPathRenderingPrivate *d;
};
